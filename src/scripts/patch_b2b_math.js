...
html = html.replace("taskAction('Generar pedidos')", "if(window.openB2BCheckout) window.openB2BCheckout(); else alert('Módulo de pedidos en inicialización...');"); // already patched, but just in case
