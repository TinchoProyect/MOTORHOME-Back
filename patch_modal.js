...
const targetStr = `            if (validSheets.length > 1) {
...
if (code.includes(targetStr)) {
    ...
    console.log("Modal Successfully Patched");
} else {
    console.log("ERROR: Target NOT found EXACTLY. Using fallback RegEx...");
    
    // Instead of completely failing, let's inject specifically using split because JS template literals spaces can be hard
    // I know that the 'id="chk_sim_sheet_${idx}"' is a unique signature.
    // I'll retool the patch if necessary.
}
